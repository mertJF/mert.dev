...
export default function Home() {
  ...
  return (
    <div className="bg-gray-800 h-screen p-20 overflow-hidden app font-lexend tracking-xxs" style={{ filter: 'sepia(1) hue-rotate(2000deg)' }}>
      ...
      <div className="flex flex-col bg-white bg-opacity-100 absolute sm:inset-20 inset-10 sm:p-20 top-10 left-10 p-10 rounded" style={{ boxShadow: '0 0 100px #ffffffbd' }}>
        <h1 className="sm:text-7xl text-6xl text-gray-800">Mert Cukuren</h1>
        <h2 className="mt-2 text-gray-700 sm:text-3xl text-2xl">UI Architect at <a href="https://jotform.com" target="_blank">Jotform</a></h2>
        <div className="flex space-x-4 mt-8 sm:text-lg">
