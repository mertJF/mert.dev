...
export default function Home() {
  return (
    <div className="bg-gray-900 text-white h-screen overflow-hidden grid place-items-center content-center text-left">
      <Head>
      ...
      <div className="flex flex-col">
        ...
        <h2 className="mt-2 text-green-400">UI Architect at JotForm</h2>
